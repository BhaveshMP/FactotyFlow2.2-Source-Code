                  ...
                  <div class="col" data-bs-toggle="modal" data-bs-target="#jake${product.id}">
                        ...
                        <div class="card card-product">
                           <div class="card-body text-center py-8">
                              <!-- img -->
                              <img src="../assets/img/${product.name}.jpg" width="150" height="150" alt="${product.name}" class="mb-3">
                              <!-- text -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 pb-4 pb-md-0 mb-3 mb-sm-3 mb-md-0">
                        <div class="container-fluid d-flex align-items-center" style="min-height: 200px;">
                            <img src="../assets/img/${product.name}.jpg" style="margin:auto;" height="300" width="200" alt="Image">
                        </div>
                    </div>
